...
`assets/js/data.js` には**実在する温泉宿11軒+ビジネス・シティホテル19軒(計30軒)**の情報を収録しています(大阪8軒を含む)。
...
- 検証の結果「風呂・トイレ別」の基準を満たすと確認できなかった施設は掲載を見送り(福岡1軒、大阪3軒=ホテル阪神大阪・カンデオホテルズ大阪なんば・ホテルモントレ グラスミア大阪。いずれも客室がユニットバスのため)
